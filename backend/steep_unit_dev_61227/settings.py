"""
Django settings for steep_unit_dev_61227 project.
...
ROOT_URLCONF = 'steep_unit_dev_61227.urls'
...
WSGI_APPLICATION = 'steep_unit_dev_61227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "steep_unit_dev_61227 API",
    "DESCRIPTION": "API documentation for steep_unit_dev_61227 App",
    "VERSION": "v1",
}
